...
\begin{problem}[De Morgan's laws]
  Let $A,B,\Omega$ be sets. (The symbol $\Omega$ is called Omega, and is
  commonly used in probability). Suppose $A,B\subseteq \Omega $ (like shown in
...
\begin{problem}[Dice sets]
  ...
  \begin{enumerate}[(a)]
    \item How many elements does $\lambda$ contain? Explain how you can count
